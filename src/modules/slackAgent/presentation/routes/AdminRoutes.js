...
module.exports = function createAdminRoutes({ adminController, authMiddleware }) {
  ...
  // ── Departments ──────────────────────────────────────────────
  router.post('/departments', authMiddleware.requireAuth, asyncHandler(adminController.createDepartment));
  router.get('/departments', authMiddleware.requireAuth, asyncHandler(adminController.listDepartments));
  ...
  // ── Categories ───────────────────────────────────────────────
  router.post('/categories', authMiddleware.requireAuth, asyncHandler(adminController.createCategory));
  router.get('/categories', authMiddleware.requireAuth, asyncHandler(adminController.listCategories));
  ...
  // ── Business Hours ───────────────────────────────────────────
  router.post('/business-hours', authMiddleware.requireAuth, asyncHandler(adminController.createBusinessHours));
  router.get('/business-hours', authMiddleware.requireAuth, asyncHandler(adminController.listBusinessHours));
