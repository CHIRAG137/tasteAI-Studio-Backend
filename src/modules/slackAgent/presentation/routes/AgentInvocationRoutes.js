...
module.exports = function createAgentInvocationRoutes({
  ...
  router.get(
    ...
    asyncHandler(agentInvocationController.getConfig),
  );
  ...
  router.patch(
    '/:agentId/invocation',
    authMiddleware.requireAuth,
    asyncHandler(agentInvocationController.updateConfig),
  );
  ...
  router.get(
    '/invocation/modes',
    authMiddleware.requireAuth,
    asyncHandler(agentInvocationController.listDefaultModes),
  );
   ...
   */
  router.post(
    '/:agentId/invocation/simulate',
    authMiddleware.requireAuth,
    asyncHandler(agentInvocationController.simulateEvent),
  );
