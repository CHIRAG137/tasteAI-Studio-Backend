...
module.exports = function createMCPRoutes({ mcpController, authMiddleware }) {
   ...
   * @access  Private
   */
  router.get('/servers/:connectionId', authMiddleware.requireAuth, asyncHandler(mcpController.getById));
   ...
   * @access  Private
   */
  router.patch('/servers/:connectionId', authMiddleware.requireAuth, asyncHandler(mcpController.update));
   ...
   * @access  Private
   */
  router.delete('/servers/:connectionId', authMiddleware.requireAuth, asyncHandler(mcpController.delete));
   ...
   * @access  Private
   */
  router.post('/servers/:connectionId/connect', authMiddleware.requireAuth, asyncHandler(mcpController.connect));
   ...
   * @access  Private
   */
  router.post('/servers/:connectionId/disconnect', authMiddleware.requireAuth, asyncHandler(mcpController.disconnect));
   ...
   * @access  Private
   */
  router.get('/servers/:connectionId/tools', authMiddleware.requireAuth, asyncHandler(mcpController.listTools));
   ...
   * @access  Private
   */
  router.post('/servers/:connectionId/execute', authMiddleware.requireAuth, asyncHandler(mcpController.executeTool));
   ...
   * @access  Private
   */
  router.get('/servers/:connectionId/health', authMiddleware.requireAuth, asyncHandler(mcpController.checkHealth));
