...
class IWorkflowRepository {
  ...
  async findTemplates() { throw new Error('Not implemented'); }
  ...
  async save(workflow) { throw new Error('Not implemented'); }
  async update(id, data) { throw new Error('Not implemented'); }
  async delete(id) { throw new Error('Not implemented'); }
  async getExecutionHistory(workflowId) { throw new Error('Not implemented'); }
  async getExecutionLogs(executionId) { throw new Error('Not implemented'); }
