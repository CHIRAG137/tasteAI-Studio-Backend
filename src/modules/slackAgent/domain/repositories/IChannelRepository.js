...
class IChannelRepository {
  ...
  async findByChannelId(workspaceId, channelId) { throw new Error('Not implemented'); }
  ...
  async save(channel) { throw new Error('Not implemented'); }
  async update(id, data) { throw new Error('Not implemented'); }
  async delete(id) { throw new Error('Not implemented'); }
  async bulkSave(channels) { throw new Error('Not implemented'); }
