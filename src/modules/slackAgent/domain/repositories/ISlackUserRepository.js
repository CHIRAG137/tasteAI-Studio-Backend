...
class ISlackUserRepository {
  ...
  async findBySlackUserId(workspaceId, slackUserId) { throw new Error('Not implemented'); }
  ...
  async findByEmail(workspaceId, email) { throw new Error('Not implemented'); }
  async findUserGroups(workspaceId) { throw new Error('Not implemented'); }
  async findTeams(workspaceId) { throw new Error('Not implemented'); }
  async findAll(filters) { throw new Error('Not implemented'); }
  async save(user) { throw new Error('Not implemented'); }
  async update(id, data) { throw new Error('Not implemented'); }
  async bulkSave(users) { throw new Error('Not implemented'); }
