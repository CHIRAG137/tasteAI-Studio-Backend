...
class INotificationRepository {
  ...
  async findByRecipientId(recipientId) { throw new Error('Not implemented'); }
  async findByOrganizationId(organizationId) { throw new Error('Not implemented'); }
  async findByChannelType(channelType) { throw new Error('Not implemented'); }
  async findPending() { throw new Error('Not implemented'); }
  async findFailed() { throw new Error('Not implemented'); }
