...
class UpdateAgentConnectorConfigUseCase {
  ...
  async execute(command) {
    ...
    const updateData = {};
    if (connectorConfig !== undefined) updateData.connectorConfig = connectorConfig;
    if (slackAiCapabilities !== undefined) updateData.slackAiCapabilities = slackAiCapabilities;
