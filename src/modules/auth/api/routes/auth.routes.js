...
/**
 * Creates and returns the Express router for all auth endpoints.
 *
 * Rate limiters use values from the central env config so they can be tuned
 * per environment without code changes.
 *
 * Error handling is delegated entirely to the global error middleware
 * (registered at the app level). No router-level error handler needed since
 * all exceptions now carry an HTTP statusCode via AppException.
 *
 * @param {{ authController, authMiddleware }} param0
